...
| sorpozhivugal | 537 | 194 | 194 | 343 |
| **All included sections** | **2511** | **994** | **994** | **1517** |
...
| sorpozhivugal | 241 | 194 | 194 | 47 |
| **All OCR-origin sections** | **962** | **876** | **876** | **86** |
...
- `sorpozhivugal/aey_thazhntha.md`: A complete public-domain Wikisource transcription has replaced the heavily damaged 29-scan OCR as the recovery base, restoring the printed title, opening, body and conclusion. The reference transcription still contains occasional spacing, punctuation and probable spelling quirks, so compare all 29 archived scans against the recovered text before translation and document each scan-proven correction.
