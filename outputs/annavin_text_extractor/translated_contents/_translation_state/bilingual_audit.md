...
| **All included sections** | **2511** | **983** | **983** | **1528** |
...
| **All OCR-origin sections** | **962** | **865** | **865** | **97** |
...
- `nadagangal/kal_sumantha_1.md`: All 13 scans are transcribed, but damaged Tamil OCR tokens remain in the king's long martial speech and require scan-level correction before fidelity can be certified
