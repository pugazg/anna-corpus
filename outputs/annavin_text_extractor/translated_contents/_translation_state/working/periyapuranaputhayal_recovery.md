...
Next: Resolve the printer-footer readings in Part 2 Image 1 and Part 5 Image 3 using a clearer witness before source release. English prose for all seven parts is drafted. Full comparative review has checked Part 1 Images 1–3; continue at Part 1 Image 4. Do not release the source or build the canonical bilingual file until both footer readings are resolved and the full review is complete. Use RMRL for missing or unreadable evidence.
