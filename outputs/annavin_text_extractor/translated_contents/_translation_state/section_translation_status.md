...
| katturaigal | 552 | 545 | 545 | 7 | 836 | 1 | 1 | 835 | 1388 | 546 | 546 | 842 |
...
| **All included categories** | **962** | **884** | **884** | **78** | **1549** | **118** | **118** | **1431** | **2511** | **1002** | **1002** | **1509** |

## Verification

- All 1002 completed files are bilingual and retain their organized source text exactly.
...
- OCR-origin progress: 884 of 962 files translated (91.9%).
- HTML-origin progress: 118 of 1549 files translated (7.6%).
- Overall progress: 1002 of 2511 files translated (39.9%).
