...
Active sequential recovery while the Periyapuranaputhayal footer hold remains open: `katturaigal/romapuri_ranigal.md`, Part 1 Images 1–2 visually reconciled; next Part 1 Image 3 (continues அரசியல் சூழல்). See `working/romapuri_ranigal_recovery.md`. No state refresh or tests for this source-only checkpoint. Previous pushed checkpoint: `e0c2bf5`.
