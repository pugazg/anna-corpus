...
Its current split is 54 works needing OCR/source recovery and 35 works whose
...
Select the next work from the live report. Prefer one of the 35 items under
`OCR translation pending` unless deliberately beginning a complete visual
recovery. Screen `sorpozhivugal/satta_17_07_1957.md` next. Do not infer scan
count from website-link count: both `desiya131159.md` and
`nilaseer200460.md` contain 22 scans and were moved to recovery after direct
checks showed extensive Tamil loss. The report is authoritative. Items found
...
current accurate split is 54 recovery / 35 translation, 89 total. The recovery
...
legal argument and closing clauses. Screen `sorpozhivugal/satta_17_07_1957.md`
next. Record scan-proven OCR corrections in ocr_concerns.csv and do not
