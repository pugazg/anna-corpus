...
Active sequential recovery while the Periyapuranaputhayal footer hold remains open: `katturaigal/romapuri_ranigal.md`, Parts 1–3 and Part 4 Images 1–7 inspected (38/82; Part 3 Image 3 printer footer unresolved, prose reconciled); next Part 4 Image 8 (begins காலமும் தன்னை எண்ணி எண்ணி). A suspected missing passage between Part 4 Images 4–5 also needs a complete witness before release. See `working/romapuri_ranigal_recovery.md`. No state refresh or tests for this source-only checkpoint. Previous pushed checkpoint: `8f1b882`.
