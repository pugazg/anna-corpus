...
Independent recovery now proceeds with விடுதலைப் போர்: Part 1 Images 1–3 inspected and bounded corrections applied; Image 3’s `கோருகின்றனர்` remains provisional. Next check that word and continue Image 4, then all remaining scans. See `working/viduthalaippor_recovery_screen.md`. Romapuri’s five gaps and two footer abbreviations still require stronger evidence; Periyapuranaputhayal hold untouched. Counts remain 886/962.
